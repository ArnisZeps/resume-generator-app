...
export default function Home() {
  return (
    <div className="flex text-white flex-col gap-6 md:gap-48 h-full bg-gradient-to-r from-violet-700 to-sky-600 justify-center ">
      <div className="w-full px-0 flex flex-col items-center max-w-7xl mx-auto md:gap-16 md:flex-row md:px-16">
        ...
        <div className="max-w-xl">
          <Image className="w-[100%] md:w-[450px] h-auto rounded-3xl" src={"/hero-1.jpg"} alt="hero-1" width={450} height={0} />
        </div>
      </div>
   </div>
  );
